...
var startsWithPipe = /** @class */ (function () {
    ...
    startsWithPipe.prototype.transform = function (value, term) {
        return value.filter(function (x) { return x.name.toLowerCase().startsWith(term.toLowerCase()) || x.surname.toLowerCase().startsWith(term.toLowerCase()); });
    };
    ...
    UsersService.prototype.refreshList = function () {
        ...
        this.http.get(this.rootUrl + '/Users')
            ...
            for (var i = 0; i < _this.list.length; i++) {
                userNamesSession.push(_this.list[i].name);
            }
